using SampleApp.Application.Enums;
...
{
    public abstract class AuditableContext : IdentityDbContext<SampleAppUser, SampleAppRole, string, IdentityUserClaim<string>, IdentityUserRole<string>, IdentityUserLogin<string>, SampleAppRoleClaim, IdentityUserToken<string>>
    {
