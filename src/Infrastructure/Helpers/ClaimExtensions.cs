...
namespace SampleApp.Infrastructure.Helpers
{
    public static class ClaimsHelper
    {
        ...
        public static async Task<IdentityResult> AddPermissionClaim(this RoleManager<SampleAppRole> roleManager, SampleAppRole role, string permission)
        {
