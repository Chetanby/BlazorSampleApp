...
using SampleApp.Infrastructure.Specifications;
...
namespace SampleApp.Infrastructure.Services.Identity
{
    public class UserService : IUserService
    {
        ...
        private async Task<string> SendVerificationEmail(SampleAppUser user, string origin)
        {
        ...
        public async Task<IResult> UpdateRolesAsync(UpdateUserRolesRequest request)
        {
            ...
            if (user.Email == "mukesh@SampleApp.com")
            {
        ...
        public async Task<string> ExportToExcelAsync(string searchString = "")
        {
            ...
            var result = await _excelService.ExportAsync(users, sheetName: _localizer["Users"],
                mappers: new Dictionary<string, Func<SampleAppUser, object>>
                {
