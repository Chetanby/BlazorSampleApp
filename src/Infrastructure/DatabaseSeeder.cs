...
using SampleApp.Infrastructure.Helpers;
using SampleApp.Infrastructure.Models.Identity;
using SampleApp.Shared.Constants.Permission;
using SampleApp.Shared.Constants.Role;
using SampleApp.Shared.Constants.User;
...
namespace SampleApp.Infrastructure
{
    public class DatabaseSeeder : IDatabaseSeeder
    {
        ...
        private readonly RoleManager<SampleAppRole> _roleManager;

        public DatabaseSeeder(
            UserManager<SampleAppUser> userManager,
            RoleManager<SampleAppRole> roleManager,
            SampleAppContext db,
        ...
        private void AddAdministrator()
        {
            Task.Run(async () =>
            {
                ...
                var adminRole = new SampleAppRole(RoleConstants.AdministratorRole, _localizer["Administrator role with full permissions"]);
                ...
                var superUser = new SampleAppUser
                {
                    FirstName = "Mukesh",
                    LastName = "Murugan",
                    Email = "mukesh@SampleApp.com",
                    UserName = "mukesh",
                    EmailConfirmed = true,
        ...
        private void AddBasicUser()
        {
            ...
            {
                //Check if Role Exists
                var basicRole = new SampleAppRole(RoleConstants.BasicRole, _localizer["Basic role with default permissions"]);
                ...
                //Check if User Exists
                var basicUser = new SampleAppUser
                {
                    FirstName = "John",
                    LastName = "Doe",
                    Email = "john@SampleApp.com",
                    UserName = "johndoe",
                    EmailConfirmed = true,
                    PhoneNumberConfirmed = true,
                    CreatedOn = DateTime.Now,
