...
using SampleApp.Client.Infrastructure.Authentication;
using SampleApp.Client.Infrastructure.Extensions;
using SampleApp.Client.Infrastructure.Routes;
using SampleApp.Shared.Constants.Storage;
...
namespace SampleApp.Client.Infrastructure.Managers.Identity.Authentication
{
    public class AuthenticationManager : IAuthenticationManager
    {
        ...
        public async Task<IResult> Login(TokenRequest model)
        {
            ...
            if (result.Succeeded)
            {
                ...
                await ((SampleAppStateProvider)this._authenticationStateProvider).StateChangedAsync();
        ...
        public async Task<IResult> Logout()
        {
            ...
            ((SampleAppStateProvider)_authenticationStateProvider).MarkUserAsLoggedOut();
