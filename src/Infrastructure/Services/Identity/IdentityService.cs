...
namespace SampleApp.Infrastructure.Services.Identity
{
    public class IdentityService : ITokenService
    {
        ...
        public IdentityService(
            UserManager<SampleAppUser> userManager, RoleManager<SampleAppRole> roleManager,
            IOptions<AppConfiguration> appConfig, SignInManager<SampleAppUser> signInManager,
        ...
        private async Task<string> GenerateJwtAsync(SampleAppUser user)
        {
            var token = GenerateEncryptedToken(GetSigningCredentials(), await GetClaimsAsync(user));
            return token;
        }

        private async Task<IEnumerable<Claim>> GetClaimsAsync(SampleAppUser user)
        {
