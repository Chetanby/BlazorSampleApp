...
using SampleApp.Client.Infrastructure.Managers.Preferences;
...
using SampleApp.Client.Infrastructure.Managers.ExtendedAttribute;
using SampleApp.Domain.Entities.ExtendedAttributes;
using SampleApp.Domain.Entities.Misc;
using Toolbelt.Blazor.Extensions.DependencyInjection;

namespace SampleApp.Client.Extensions
{
    public static class WebAssemblyHostBuilderExtensions
    {
        private const string ClientName = "SampleApp.API";
        ...
        public static WebAssemblyHostBuilder AddClientServices(this WebAssemblyHostBuilder builder)
        {
            builder
                ...
                .AddScoped<SampleAppStateProvider>()
                .AddScoped<AuthenticationStateProvider, SampleAppStateProvider>()
                .AddManagers()
